...
public class CasLoginAct {
	...
	@Autowired
	private BbsAuthenticationFilter authcFilter;
	...
	@RequestMapping(value = "/loginByElekta.jspx")
	public String loginByElekta(HttpServletRequest request,HttpServletResponse response, ModelMap model) {
		...
		site=cmsSiteMng.findById(site.getId());
